...
class ProcessList extends StatelessWidget {
  ...
  int getDiffTime(DateTime time){
    ...
    if(different.inMinutes>60)
      return 60;
    else return different.inMinutes;
  }
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return listCard(dateFormated[0],
                          dateFormated[2],
                          dateFormated[1], item: item, minutes: minutes);
                    },
  ...
  Widget listCard(String day, String date, String month, {required HistoryModel item, required int minutes}) {
